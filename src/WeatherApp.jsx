...
const WeatherApp = () => {
  ...
  return (
    <>
      <div className="__weather d-flex flex-column justify-content-center align-items-center my-auto py-2">
        <div className="__container col-8 container">
          {weatherData && (
            <div className="container align-item-center justify-content-center mt-2">
          ...
          >
            <input
              className="col-4 p-2 my-auto mx-1"
              type="text"
              name="city"
              value={city}
            ...
            />
            <button
              className="btn btn-md btn-block btn-primary px-3 py-auto mx-1"
              type="submit"
            >
              Buscar
            </button>
